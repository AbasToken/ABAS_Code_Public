...
function updateAllMinerInfo(eth, stats, hours_into_past){
  ...
  var last_difficulty_start_block = getValueFromStats('Last Difficulty Start Block', stats) - 1500000
  ...
  .then((result) => {
    ...
    var innerhtml_buffer = '<tr><th>Time (Approx)</th><th>Eth Block #</th>'
      + '<th>Transaction Hash</th><th>Amount</th><th>Sender</th></tr>';
	...
	console.log("DATA HERE?: ", block_info);
	dataMoreThan10000 = true
	if((known_miners[addr] !== undefined) || test > 14500){
      ...
      innerhtml_buffer  += '<tr><td>'
        ...
        + '<a href="' + transaction_url + '">' + test.toString() + '</td><td>'        
