...
/* intrinsic values */
/* intrinsic values */
const _SECONDS_PER_ETH_BLOCK = 0.3;
const _ZERO_BN = new Eth.BN(0, 10);
/* contract constants */
/* todo: pull these from the contract */
/* todo: move these into some kind of contract helper class */
const _CONTRACT_NAME = "Arbitrum Bitcoin and Staking";
const _CONTRACT_SYMBOL = "ABAS";
const _CONTRACT_ADDRESS = "0x0afaF0C46B1cA13B204a516BF5c0314674f4930D"; //ABAS
const _CONTRACT_ADDRESS2 = "0x73d61cbDCD1EA284c86E5fcd4ACE367daA3b3F77"; //auction
const _CONTRACT_ADDRESS3 = "0x857D66237491fCefe0C70080e2CA0f78F941A840"; //staking contract for LPers
const _CONTRACT_ADDRESS4 = "0x748951b8730da625d35a9a983d83b1a46afb7ca6"; //LP token
const _CONTRACT_ADDRESS5 = "0xCDaFe656e0150e7aEEc590eAa344D84f0791016b"; //balancer HELPER
const _CONTRACT_ADDRESS6 = "0x9C2bFE65CE567d2df89c8e3F9FB05B128C4cB384"; //staking contract for LPers #2 #2 #2
const _CONTRACT_ADDRESS7 = "0xe8505551eaff948449198524fd3590fd22704e7e"; //LP token #2 #2 #2
...
const _LAST_DIFF_START_BLOCK_INDEX = '32';
const _ERA_INDEX = '10'; //getEpoch
...
var eth = new Eth(new Eth.HttpProvider("https://arb-mainnet.g.alchemy.com/v2/WHa04zxQ0-gU4lKeWM0Se47WOG8RZpg3"));
...
// }
var _BLOCK_EXPLORER_ADDRESS_URL = 'https://arbiscan.io/address/';
var _BLOCK_EXPLORER_TX_URL = 'https://arbiscan.io/tx/';
var _BLOCK_EXPLORER_BLOCK_URL = 'https://arbiscan.io/block/';
...
var known_miners = {
  "0xdfd18d5374df275a8ede107f981f78b1e60f63e4" : [ "ABAS Mining Pool", "http://abastoken.org:11181",     pool_colors.orange ],
  "0xf118fde3f634e5c47638030ab0514debf39465d1" : [ "ABAS Mining Pool", "http://abastoken.org:11181",     pool_colors.orange ], // mint helper contract (old)
  "0xeabe48908503b7efb090f35595fb8d1a4d55bd66" : [ "ABAS Mining Pool", "http://abastoken.org:11181",     pool_colors.orange ], // mint helper contract
...
stats = [
 ...
 ['Total Supply in all Balancer Pool 1',               token4.totalSupply,                      "",                0.000000000000000001,          null     ], /* mining */
   ['TotalSupply Staking Contract Pool 1',   token3.totalSupply,  "",                 0.000000000000000001,          null     ], /* mining difficulty */
   ['RewardRate Pool 1',   token3.rewardRate,  "",                 1,          null     ], /* mining difficulty */
   ['RewardRate3 Pool 1',   token3.rewardRate3,  "",                 1,          null     ], /* mining difficulty */
  ['Pool 1 Num1 Token',                token5.pool1Stats,                      "ABAS",                 0.000000000000000001,          null     ], /* mining */
    ['Pool 1 Num2 Token',                token5.pool1Stats,                      "ETH",                 0.000000000000000001,          null     ], /* mining */
      ['APY Pool 1',                token4.totalSupply,                      "ETH",                 0.000000000000000001,          null     ], /* mining */
        ['Pool 1 Total Liquidity',               null,                      "",                 1,          null     ], /* mining */
       ['Pool 1 Percent Of Liquidity In Staking',               null,                      "",                 1,          null     ], /* mining */

  ['POOL TWO POOL TWO POOL TWO UNDER',                              null,                                 "",                 1,          null     ], /* */
  ['',                              null,                                 "",                 1,          null     ], /* */
 
 ['Total Supply in all Balancer Pool 2',               token7.totalSupply,                      "",                 0.000000000000000001,          null     ], /* mining */
   ['TotalSupply Staking Contract Pool 2',   token6.totalSupply,  "",                 0.000000000000000001,          null     ], /* mining difficulty */
   ['RewardRate Pool 2',   token6.rewardRate,  "",                 1,          null     ], /* mining difficulty */
   ['RewardRate3 Pool 2',   token6.rewardRate3,  "",                 1,          null     ], /* mining difficulty */
   ['Pool 2 Num1 Token',                              token5.poolTWOStats,                                 "ABAS",              0.000000000000000001,          null     ], /* */
   ['Pool 2 Num2 Token',                              token5.poolTWOStats,                                 "0xBTC",                 0.00000001,          null     ], /* */
    ['Pool 2 Num3 Token',                              token5.poolTWOStats,                                 "bForge",                 0.000000000000000001,          null     ], /* */
       ['APY Pool 2',                token7.totalSupply,                      "ETH",                 0.000000000000000001,          null     ], /* mining */
       ['Pool 2 Total Liquidity',               null,                      "",                 1,          null     ], /* mining */
       ['Pool 2 Percent Of Liquidity In Staking',               null,                      "",                 1,          null     ], /* mining */
  ['',                              null,                                 "",                 1,          null     ], /* */
 ['',                              null,                                 "",                 1,          null     ], /* */
...
['Mining Difficulty',             token.getMiningDifficulty,            "",                 1,          null     ], /* mining difficulty */
 ...
 ['Average Reward per Solve',   null,                                 "minutes",          1,          null     ], /* mining difficulty */
...
['Tokens distributed via Mining',                 token.tokensMinted,                   _CONTRACT_SYMBOL,   0.000000000000000001, null     ], /* supply */
 ['Tokens distributed via Staking',                 null,                   _CONTRACT_SYMBOL,   1, null     ], /* supply */
 ['Tokens distributed via Auctions',                 token2.currentDay,                   _CONTRACT_SYMBOL,  32768, null     ], /* supply */
  ['',                              null,                                 "",                 1,          null     ], /* */
  
  ['Total Forge Circulating Supply',     null,                                 "Forge",          1,          null     ], /* mining difficulty */
 ['Inflation Percentage Per Year', null,  "",                 1,          null     ], /* supply */
  ['Inflation Amount Per Year', null,  "",                 1,          null     ], /* supply */
 //adjust max supply as needed 0.00000000000344 is just guess
['Max Supply for Current Era',    token.maxSupplyForEra,                _CONTRACT_SYMBOL,   0.000000000000000003477, null     ], /* mining */ 
...
['',                              null,                                 "",                 1,          null     ], /* */
 ...
 ['Total 0xBitcoin spent at Auctions',  token2.totalBurnt,                   "E",   0.000000000000000001, null     ], /* supply */
  ['',                              null,                                 "",                 1,          null     ], /* */
...
['Mining Reward at 360 minutes Solve',         null,                _CONTRACT_SYMBOL,   1, null     ], /* mining */
 ['Mining Reward at 12 minutes Solve',         null,                _CONTRACT_SYMBOL,   1, null     ], /* mining */
...
['Token Holders',                 null,                                 "holders",          1,          null     ], /* usage */
 ...
 ['Last Eth Block',                null,                      "",                 1,          null     ], /* mining */
  ['Last Arbitrum Block Number',                eth.blockNumber,                      "",                 1,          null     ], /* mining */
...
if(test5 != -1){
  ...
  el_safe('#MiningRewardat360minutesSolve').innerHTML = "<b> "+(1400).toLocaleString()+" </b> ABAS";
  el_safe('#MiningRewardat12minutesSolve').innerHTML = "<b> "+(3.5).toLocaleString()+" </b> ABAS";
...
//DO MY STUFF
  ...
  liqForge =2
  totalCircLPTokens = getValueFromStats('APY Pool 1', stats)
  totalContractLPTokens = getValueFromStats('TotalSupply Staking Contract Pool 1', stats)


  ratioStakedPool1 =  totalContractLPTokens / totalCircLPTokens
	console.log("totalCircLP1: ", totalCircLPTokens);
	console.log("totalCircLP12: ", totalContractLPTokens);
//Times the ABAS in the contract * contractBal / totalBal
  totalPool1Num1 = getValueFromStats('Pool 1 Num1 Token', stats)	

  el_safe('#Pool1Num1Token').innerHTML = "<b>" + (totalPool1Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> ABAS  ";



  totalPool1Num2 = getValueFromStats('Pool 1 Num2 Token', stats)	
  el_safe('#Pool1Num2Token').innerHTML = "<b>" + (totalPool1Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 6}) + " </b> ETH  ";

 el_safe('#Pool1TotalLiquidity').innerHTML = "<b>" + (totalPool1Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> ABAS  and " + "<b>" + (totalPool1Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 16}) + " </b> ETH  ";
  el_safe('#Pool1PercentOfLiquidityInStaking').innerHTML = "<b>" + (ratioStakedPool1*100).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 6}) + " </b> % ";

	console.log("totalPool1Num1: ", totalPool1Num1);
	dddd = totalPool1Num1 * totalContractLPTokens / totalCircLPTokens * 10 ** 18

	dddd2 = totalPool1Num2 * totalContractLPTokens / totalCircLPTokens * 10 ** 18

// ffff / dddd = equation.  Get ffff now
	
  rewardRate1p1 = getValueFromStats('RewardRate Pool 1', stats)	
	ffff = rewardRate1p1 / (10**16) * (60*60*24*365)

  rewardRate3p1 = getValueFromStats('RewardRate3 Pool 1', stats)
	ffff2 = rewardRate3p1 / (10**16) * (60*60*24*365)


	console.log("totalrewardrate1: ", ffff);
	console.log("totalrewardrate3: ", ffff2);
	apy1 = ffff / dddd / 2 * 100
	apy2 = ffff2 / dddd2 / 2 * 100

	console.log("apy1: ", apy1);
	console.log("apy2: ", apy2);
	totalAPY = (apy1 + apy2)
	console.log("Total Apy: ", totalAPY);


  el_safe('#APYPool1').innerHTML = "<b>" + (totalAPY).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 0}) + " </b> % APY  ";





  totalCircLPTokens2 = getValueFromStats('APY Pool 2', stats)
  totalContractLPTokens2 = getValueFromStats('TotalSupply Staking Contract Pool 2', stats)	
//Times the ABAS in the contract * contractBal / totalBal
  totalPool2Num1 = getValueFromStats('Pool 2 Num1 Token', stats) //0xBTC

  totalPool2Num2 = getValueFromStats('Pool 2 Num2 Token', stats) //ABAS	
  totalPool2Num3 = getValueFromStats('Pool 2 Num3 Token', stats) //bForge

  ratioStakedPool2 = totalContractLPTokens2 / totalCircLPTokens2	
  el_safe('#Pool2Num3Token').innerHTML = "<b>" + (totalPool2Num3).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> bForge  ";
  ...
  el_safe('#Pool2Num1Token').innerHTML = "<b>" + (totalPool2Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 6}) + " </b> ABAS  ";



  totalPool1Num2 = getValueFromStats('Pool 1 Num2 Token', stats)	
  el_safe('#Pool2Num2Token').innerHTML = "<b>" + (totalPool2Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> 0xBTC  ";

 el_safe('#Pool2TotalLiquidity').innerHTML = "<b>" + (totalPool2Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 5}) + " </b> ABAS  and " + "<b>" + (totalPool2Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> 0xBTC and <b>" + (totalPool2Num3).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> bForge  ";
  el_safe('#Pool2PercentOfLiquidityInStaking').innerHTML = "<b>" + (ratioStakedPool2*100).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 6}) + " </b> % ";





	v2 = 10 ** 18 * totalPool2Num2 * totalPool1Num2 / totalPool1Num1
	dddd = totalPool2Num2 * totalContractLPTokens2 / totalCircLPTokens2 * 10 ** 18

	dddd2 = v2 * totalContractLPTokens2 / totalCircLPTokens2

	console.log("dddd2: ", dddd2	);
// ffff / dddd = equation.  Get ffff now
	
  rewardRate1p2 = getValueFromStats('RewardRate Pool 2', stats)	
	ffff = rewardRate1p2 / (10**16) * (60*60*24*365)

  rewardRate3p2 = getValueFromStats('RewardRate3 Pool 2', stats)
	ffff2 = rewardRate3p2 / (10**16) * (60*60*24*365)


	apy1 = ffff / dddd / 3 * 100
	apy2 = ffff2 / dddd2 / 3 * 100

	totalAPY2 = (apy1 + apy2)
	console.log("Total Apy: ", totalAPY2);

	console.log("totalPool1Num1 aka Abas: ", totalPool1Num1	);
	console.log("v2: ", v2	);

  el_safe('#APYPool2').innerHTML = "<b>" + (totalAPY2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 0}) + " </b> % APY  ";
...
console.log("First _IDEAL_BLOCK_TIME_SECONDS:", _IDEAL_BLOCK_TIME_SECONDS);
  ...
  liqForge = 123 //getValueFromStats('Liquidity', stats)	


  el_safe('#Liquidity').innerHTML = "<b>" + (liqForge).toFixed(0) + " </b> ABAS  ";



  liq0xx = 255 // getValueFromStats('u4', stats) /100000000
...
apy = apy + apyz2
  el_safe('#StakingAPY').innerHTML = "<b>" + (apy) + " </b> %";
...
if(test5 != -1){
  ...
  el_safe('#TokensdistributedviaMining').innerHTML = "<b>" + freadsf2 + " </b> ABAS";
  freadsffff = getValueFromStats('Auction Length', stats)

  el_safe('#AuctionLength').innerHTML = "<b>" + freadsffff.toFixed(1) + " </b> days";

  freadsf2 = getValueFromStats('Current Mining Reward per 12 minute Solve', stats)

  el_safe('#CurrentMiningRewardper48minuteSolve').innerHTML = "<b>" + freadsf2.toFixed(0) + " </b> ABAS";


  freadsf = getValueFromStats('Tokens distributed via Mining', stats) * 2
...
if(test5 != -1){
  ...
  el_safe('#TokensdistributedviaStaking').innerHTML = "<b>" + freadsf2 + " </b> ABAS";
  auction_tot2 = getValueFromStats('Total 0xBitcoin spent at Auctions', stats)
  
  el_safe('#Total0xBitcoinspentatAuctions').innerHTML = "<b>" + auction_tot2.toFixed(8) + " </b> ETH";
  ...
  circl = getValueFromStats('Tokens distributed via Mining', stats) * 3 + getValueFromStats('Current Auction', stats)*32768-32768
...
if(test51 != -1){
  ...
  el_safe('#TotalForgeCirculatingSupply').innerHTML = "<b>" + circl2 + " </b> ABAS";
  ...
  current_eth_block = getValueFromStats('Last Arbitrum Block Number', stats)
...
console.log("current_eth_blockdifficulty_start_eth_block", difficulty_start_eth_block)
  ...
  el_safe('#CurrentAverageRewardTime').innerHTML = "<b>" + (seconds_per_reward / 60).toFixed(3) + "</b> minutes";
 ...
 hashy = getValueFromStats('Mining Difficulty', stats)*2
  ...
  epoch_old = getValueFromStats('Epoch Old', stats)
	...
	if(seconds_per_reward < targetTimez){
...
log("mine_length", mine_Length2)
 /*Get Inflation % per year */
  ...
  last_Block = getValueFromStats('Last Arbitrum Block Number', stats)
...
if(test5 != -1){
  ...
  el_safe('#MinedSupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era2 + "</b> " + _CONTRACT_SYMBOL + " <span style='font-size:0.8em;'>(" +rewards_blocks_remaining_in_era2 + " epochs @ "+secondsToReadableTime(seconds_per_reward)+" a epoch)</span>";

}else{
  el_safe('#MinedSupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era.toLocaleString() + "</b> " + _CONTRACT_SYMBOL + " <span style='font-size:0.8em;'>(" +rewards_blocks_remaining_in_era2.toFixed(0) + " epochs @ "+secondsToReadableTime(seconds_per_reward)+" a epoch)</span>";
}
...
el_safe('#AverageRewardPerSolve').innerHTML += "<b> "+current_Reward.toFixed(3) + "</b> ABAS per solve @ epoch Time of "+ secondsToReadableTime(seconds_per_reward)

el_safe('#TargetTime').innerHTML = "<b>"+targetTimez/60+"</b> minutes";
//inflation math below
  inflation = (32768 / auction_Length * year_Time) + ((current_Reward * epoch_From) / seconds_Total ) * year_Time * 3
  inflation = inflation
...
function updateThirdPartyAPIs() {
  ...
  $.getJSON('https://raw.githubusercontent.com/Untouchable2k/Forge-Main/main/holdersandtrans2.html',
    function(data) {
...
function updateAllMinerInfo(eth, stats, hours_into_past){
  ...
  var last_reward_eth_block = getValueFromStats('Last Arbitrum Block Number', stats)
  var current_eth_block = getValueFromStats('Last Arbitrum Block Number', stats)
...
if(stat[0]=='TotalSupply Staking Contract Pool 1' || stat[0] =='Total Supply in all Balancer Pool 1'  || stat[0] =='RewardRate Pool 1'  || stat[0] =='RewardRate3 Pool 1'  || stat[0] =='Pool 1 Num1 Token'  || stat[0] =='Pool 1 Num2 Token'  || stat[0] =='Epoch Old'   || stat[0] =='SecondsPerDay Auction Contract' ){
	goodStat = false;
	if(!ShowStats){
		goodStat = true;
		}
...
if(goodStat && stat[0]!='u2' && stat[0] != 'Current Mining Reward per 12 minute Solve' && stat[0] != 'u4' && stat[0] != 'u5' && stat[0] != 'u6' && stat[0] != 'u7' && stat[0] != 'Last Eth Block' && stat[0] != 'u8' && stat[0] != 'u9'){
...
function updateStatsTable(stats){
  stats.forEach(function(stat){
	...
	if(stat_name=="Pool 1 Num2 Token" || stat_name=="Pool 2 Num3 Token"){
		xx = 1
