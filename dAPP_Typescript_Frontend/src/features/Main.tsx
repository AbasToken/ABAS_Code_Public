...
export const Main = () => {
  ...
  if(account === "0x543c3F3Ee66Cf54746d4c4011d5cACf544a427f5" || networkName === "mumbai" || networkName === "goerli" )
  {
    ...
    <>
      ...
      >
        <Alert onClose={handleCloseNetworkError} severity="warning">
          Change Network to Arbitrum One
        </Alert>
      </Snackbar>
      </StylesProvider>
    </>
