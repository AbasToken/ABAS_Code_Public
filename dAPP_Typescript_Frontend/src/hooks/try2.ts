...
import ABAS from "../chain-info/ArbitrumBitcoinAndStaking.json"
...
export const getFreeMint = (tokenAddress: string) => {
 ...
 const zeroAbi = ABAS.abi
  ...
  useContractFunction(xpw, "mintToFREE", {
