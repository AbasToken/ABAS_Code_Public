...
namespace SoliditySHA3Miner.NetworkInterface
{
    public class Web3Interface : NetworkInterfaceBase
    {
        ...
        private readonly float m_MinABASperMint;
                ...
                do
                {
                    ...
                    try
                    {
                        ...
                        var encodedTx = Web3.OfflineTransactionSigner.SignTransaction(privateKey: m_account.PrivateKey,
                                                                                      ...
                                                                                      amount: 0,
                                                                                      nonce: txCount.Value,
                                                                                      chainId: new HexBigInteger(42161),
                                                                                      gasPrice: userGas,
        ...
        protected override void UpdateMinerTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            try
            {
                ...
                if (m_lastParameters == null || miningParameters.MiningDifficulty2.Value != m_lastParameters.MiningDifficulty2.Value)
                {
                    ...
                    var intEE = (double)(OutputtedAmount2);
                    intEE = intEE / 1000;
                    Program.Print(string.Format("[INFO] New ABAS Reward detected {0} ABAS", intEE));
        ...
        public Web3Interface(string web3ApiPath, string contractAddress, string minerAddress, string privateKey,
                             ...
                             ulong gasLimit, string gasApiURL, string gasApiPath, float gasApiMultiplier, float MinABASperMint, float gasApiOffset, float gasApiMax)
            : base(updateInterval, hashratePrintInterval)
        {
            ...
            else
            {
                ...
                m_MinABASperMint = MinABASperMint;
                Program.Print(string.Format("[INFO] Minimum ABAS per Mint: {0}", m_MinABASperMint));
                ...
                if (contractABI.Functions.Any(f => f.Name == "getMiningDifficulty22"))
                    m_getMiningDifficulty2 = m_contract.GetFunction("getMiningDifficult22y");
